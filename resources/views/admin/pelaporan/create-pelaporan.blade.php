...
@section('content')
<h2 style="font-size: 18px; font-weight: 700; margin-bottom: 30px;">Tambah Pelaporan</h2>
    ...
    <div class="form-container">
        ...
        <div class="form-column">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-input" rows="8" placeholder="Aksesoris x50, Nampan x10, dsb"></textarea>
            </div>
        </div>
        ...
        <div class="form-column">
            ...
            <div class="form-group">
                <label>Kode</label>
                <input type="text" name="kode_laporan" class="form-input" value="{{ $autoKode }}" readonly>
            </div>
        </div>
    </div>
